...
* the member opmodel.dev/catalogs/opm/traits/resource-name@v1beta1 leaves the catalog and the module path crosses to opmodel.dev/catalogs/opm@v4 (4.0.0). Exact names are authored on metadata.resourceName.
...
* drop the resource-name trait, cut opmodel.dev/catalogs/opm@v4 ([#74](https://github.com/open-platform-model/catalog_opm/issues/74)) ([089c2dd](https://github.com/open-platform-model/catalog_opm/commit/089c2dd99e1c675f52714254489582480a086916))
